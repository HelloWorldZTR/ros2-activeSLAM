...
alias r1='ros2 launch activeslam slam.launch.py map:=slam_rooms'
alias r2='ros2 run activeslam slam_evaluator --ros-args -p use_sim_time:=true -p world_name:=slam_rooms'
...
source /home/psirobot/projects/ros2_ws/src/install/setup.zsh
