...
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[height=0.13\textheight]{imgs/slam_landmarks_inferred.pdf}\\
    \textbf{(a)} \texttt{slam\_landmarks}
\end{minipage}
\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[height=0.13\textheight]{imgs/slam_loop_inferred.pdf}\\
    \textbf{(b)} \texttt{slam\_loop}
\end{minipage}
\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[height=0.13\textheight]{imgs/slam_rooms_inferred.pdf}\\
