...
\begin{figure*}[t]
\centering
\includegraphics[width=0.31\linewidth]{imgs/slam_landmarks_coverage_comparison.pdf}
\hfill
\includegraphics[width=0.31\linewidth]{imgs/slam_loop_coverage_comparison.pdf}
\hfill
\includegraphics[width=0.31\linewidth]{imgs/slam_rooms_coverage_comparison.pdf}\\
\makebox[0.31\linewidth]{\textbf{(a)} \texttt{slam\_landmarks}}
\hfill
\makebox[0.31\linewidth]{\textbf{(b)} \texttt{slam\_loop}}
\hfill
...
The coverage curves in \Cref{fig:coverage_comparison} show that the proposed hierarchical GVD model increases map coverage faster than the baselines on all three maps. It also reaches a higher final overall coverage than the frontier, graph-guided frontier, and GBSAE baselines. Notably, this advantage remains even against GBSAE, which is given the green prior graph shown in \Cref{fig:test_maps}.
