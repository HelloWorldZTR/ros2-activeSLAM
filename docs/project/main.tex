...
\begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=0.15\textheight]{imgs/slam_rooms.jpg}\\
    \textbf{(a)} \texttt{slam\_rooms}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=0.15\textheight]{imgs/slam_office.jpg}\\
    \textbf{(b)} \texttt{slam\_office}
\end{minipage}
\caption{Simulation maps used for evaluating active exploration policies.}
\label{fig:test_maps}
\end{figure*}
